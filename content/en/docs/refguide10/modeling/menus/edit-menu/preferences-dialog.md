...
For more information about the styling editor, see the [Using the Styling Editor](/howto10/front-end/customize-styling-new/#styling-editor) section in *How to Customize Styling*.
